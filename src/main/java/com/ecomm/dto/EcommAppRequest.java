...
public class EcommAppRequest {
	...
	public int hashCode() {
		...
		result = prime * result + ((orderProductDtos == null) ? 0 : orderProductDtos.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EcommAppRequest other = (EcommAppRequest) obj;
		if (category == null) {
		...
		if (orderProductDtos == null) {
			if (other.orderProductDtos != null)
				return false;
		} else if (!orderProductDtos.equals(other.orderProductDtos))
			return false;
		if (password == null) {
